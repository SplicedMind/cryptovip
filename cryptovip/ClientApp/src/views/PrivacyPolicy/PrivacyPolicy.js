      ...
      <div className={classNames(classes.main, classes.mainRaised)} style={{marginTop:"100px"}}>
        <div className={classes.container} style={{color:"black"}}>
            ...
            <div>
                ...
                <p>We use cookies and other tracking technologies to personalize your experience, analyze user trends, 
                ...
                <h6 className={classes.title} style={{color:"black"}}>Updates</h6>
                <p>
                    We may update or change this Privacy Statement from time to time and without prior notice to you. The top of this Privacy Statement will indicate when it was most recently updated.
                </p>
                                <br/><br/>
            </div>          
        </div>
